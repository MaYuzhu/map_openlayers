...
init = function() {
    ...
    vectorGroup = [ new OpenLayers.Layer.TMS("矢量底图",
        [
            ...
            "http://t4.tianditu.com/DataServer" //http://t0.tianditu.gov.cn/vec_c/wmts?tk=您的密钥
        ], {
            type : "vec_w",
            getURL : get_my_url,
            isBaseLayer : true,
...
getURL = function (bounds) {
    ...
    var y = Math.round ((this.maxExtent.top - bounds.top) / (res * this.tileSize.h));
    var z = this.map.getZoom();
    var path = "?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER="+this.type+"&STYLE=default&TILEMATRIXSET=w&TILEMATRIX="+z+"&TILEROW="+y+"&TILECOL="+x+"&FORMAT=tiles&tk=207653a6c628d6e51d1cd31598ae0b9f";
